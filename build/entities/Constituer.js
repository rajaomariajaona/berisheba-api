...
var Constituer = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return DemiJournee_1.DemiJournee; }, function (DemiJournee) { return DemiJournee.constituers; }, { primary: true, nullable: false, onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
