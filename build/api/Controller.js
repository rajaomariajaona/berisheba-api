...
var Controller = /** @class */ (function () {
    ...
    Controller.prototype.addAllRoutes = function (router) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.addGet(router)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.addPost(router)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.addDelete(router)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.addPut(router)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.addErrorHandler(router)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
