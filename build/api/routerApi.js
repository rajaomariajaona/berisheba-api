...
var SalleController_1 = __importDefault(require("./routes/SalleController"));
var MaterielController_1 = __importDefault(require("./routes/MaterielController"));
...
router.use("/salles", new SalleController_1.default().mainRouter);
router.use("/materiels", new MaterielController_1.default().mainRouter);
